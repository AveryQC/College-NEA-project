Module Module1
    ...
    Function MazeInitialisation(ByRef mazeWidth As Integer, ByRef mazeHeight As Integer, ByVal mazeMode As String)
        ...
        'maze generation starting points
        ...
        'backtrack movement stack and pointer
    ...
    Sub MazeDisplay(ByVal maze As String(,), ByVal mazeWidth As Integer, ByVal mazeHeight As Integer)
        ...
        '        If Len(maze(r, l)) - 1 = 1 Then
        '            Console.Write(maze(r, l) & "   ")
        '        ElseIf Len(maze(r, l)) - 1 = 2 Then
        '            Console.Write(maze(r, l) & "  ")
        '        ElseIf Len(maze(r, l)) - 1 = 3 Then
        '            Console.Write(maze(r, l) & " ")
        '        ElseIf maze(r, l).Contains("Q") Then
        '            Console.Write(" Q   ")
        '        Else
        '            Console.Write(" ~   ")
        '        End If
...
Select/confirm:  ENTER")
                        ...
                        Case 1
                            ...
                            While playerColour = 0
                                ...
                                Catch ex As Exception
                                    ...
                                    Console.Clear()
                                End Try
                                If playerColour > 0 And playerColour < 13 Then
                        ...
                        Case 2
                            ...
                            While trailColour = 0
                                ...
                                Catch ex As Exception
                                    ...
                                    Console.Clear()
                                End Try
                                If trailColour > 0 And trailColour < 13 Then
                                    Console.Write("Colour saved!")
                                    Threading.Thread.Sleep(800)
    ...
    Sub Main()
        ...
        While repeat = True
            ...
            Console.Clear()
            Dim maze(,) As String = MazeInitialisation(mazeWidth, mazeHeight, mazeMode)
            MazeDisplay(maze, mazeWidth, mazeHeight)
